...
content = html.Div(className="col-sm",
                   children=[
                       dbc.Row(
                           [
                               dbc.Col(mydbc.dropdown(id="City", label="City", list_options=city_lbl, value="",
                                                      searchable=False, clearable=False)),
                               dbc.Col(
                                   mydbc.dropdown(id="Product_type", label="Product type", list_options=prod_type_lbl,
                                                  searchable=False, clearable=False)),
                               dbc.Col(mydbc.dropdown(id="Manufacturer", label="Manufacturer", list_options=[],
                                                      searchable=False, clearable=False, optionHeight=80)),
                               dbc.Col(mydbc.dropdown(id="Product", label="Product", list_options=[], value="",
                                                      searchable=False, clearable=False, optionHeight=80)),
                           ],
                           no_gutters=True
                       ),
                       ...
                       dbc.Row(
                           children=[
                               dbc.Col(children=[
                                   dbc.Col(
                                       children=[
                                           dbc.Row(children=[dbc.Label('RMSE:', html_for='Label_rmse',
                                                                       className="col-form-label col-sm", )]),
                                           dbc.Row(children=[
                                               dcc.Textarea(id='rmse_display', value='', contentEditable=False,
                                                            disabled=True)])]
                                   ...
                                   dbc.Col(
                                       children=[
                                           dbc.Row(children=[
                                               dbc.Label("% observations into C.I.:", html_for='Label_rmse',
                                                         className="col-form-label col-sm")]),
                                           dbc.Row(children=[
                                               dcc.Textarea(id='CI_display', value='', contentEditable=False,
                                                            disabled=True)])]
                                   ),
                                   dbc.Col(
                                       children=[
                                           dbc.Row(children=[
                                               dbc.Label('Yearly Seasonality:', html_for='Label_yearly_season',
                                                         className="col-form-label col-sm")]),
                                           dbc.Row(children=[
                                               dcc.Textarea(id='Year_seasonality', value='', contentEditable=False,
                                                            disabled=True)])]
                                   ),
                                   dbc.Col(
                                       children=[
                                           dbc.Row(children=[
                                               dbc.Label('Monthly Seasonality:', html_for='Label_monthly_season',
                                                         className="col-form-label col-sm")]),
                                           dbc.Row(children=[
                                               dcc.Textarea(id='Month_seasonality', value='', contentEditable=False,
                                                            disabled=True)])]
                                   ),
                                   dbc.Col(
                                       children=[
                                           dbc.Row(children=[dbc.Label('Last Updated:', html_for='Label_last_updated',
                                                                       className="col-form-label col-sm")]),
                                           dbc.Row(children=[
                                               dcc.Textarea(id='Last_updated', value='', contentEditable=False,
                                                            disabled=True)])]
                                   )],
                                   width=3
                               ),
...
layout = html.Div(children=[
    mydbc.card(content=content, title="Forecast",
               description="Here you can find interesting data about Teaté's products forecast", color="light",
               footer="")
], className="my-2")
