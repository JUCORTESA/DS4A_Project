         ...
         dbc.Row([
              html.Div(className = "embed-responsive embed-responsive-16by9",
                children = [
                    ...
                    figure={
                        'data': [
                                {'x': [1, 2, 3], 'y': [3, 4, 4], 'type': 'line', 'name': 'Prediction'},
                                {'x': [1, 2, 3], 'y': [2, 4, 5], 'type': 'line', 'name': 'Real'},
                                ],
                        'layout': {
...
layout = html.Div(children=[
        mydbc.card(content=content, title="Forecast", description="Here you can find interesting data about Teaté's products forecast", color="light", footer="footer")
    ], className="my-2")